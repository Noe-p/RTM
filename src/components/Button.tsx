...
export function Button(props: ButtonProps): JSX.Element {
  const {text, style, isWhite, arrow=true} = props;

  return (
    <ButtonStyled style={style} $isWhite={isWhite}>{text} {arrow && <ArrowStyled/>}
    </ButtonStyled>
  );
}
...
const ButtonStyled = styled.button<{ $isWhite?: boolean }>`
    ...
    background-color: ${props => props.$isWhite ? COLORS.WHITE : COLORS.ORANGE};
